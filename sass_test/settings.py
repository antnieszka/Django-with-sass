"""
Django settings for sass_test project.
...
SECRET_KEY = 'zo%0*o9whx!(u9ma@v+421xm!su-=%)htzj6=e*vcabt_82ur3'
...
WSGI_APPLICATION = 'sass_test.wsgi.application'
